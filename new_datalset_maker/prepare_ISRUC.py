...
written_channels = ['EOG E1-M2', 'EOG E2-M1', 'EEG F3-M2', 'EEG C3-M2', 'EEG O1-M2', 'EEG F4-M1', 'EEG C4-M1', 'EEG O2-M1']
...
if __name__ == "__main__":
    ...
    parser.add_argument('--output', type=str, default=r"E:\dataset\ISRUC_NO",
